...
//
//  Created by Felipe Filgueira on 6/17/25.
//
...
final class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedResult_matchesFixedTestAccountdata()  {
        ...
        case .success(let items)?:
            XCTAssertEqual(items.count, 8, "Expected 8 itens in the test account feed")
...
//            }
        ...
        case nil:
            XCTFail("Expected successfull feed result, got nil instead")
        }
    }
